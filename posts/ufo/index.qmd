...
Some time ago, when the fall semester began I've enrolled on a course called *Data science lab* as part of the 'Data Science for the Social Sciences' program. One of the assignments was to make some `TidyTuesday` contribution and present it in class. Although this is not what I've presented in class (see the post about that one here), this was made shortly after and I think it came out quite nice :)
