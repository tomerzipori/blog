...
This essentially creates a $20,000 \times 6$ array of 20,000 "simulated elections" based on the model, and the vote share of each of the 6 candidates. For example, here are the first 5 simulated elections and the vote share in each:
